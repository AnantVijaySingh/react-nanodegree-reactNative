    ...
    render() {
        ...
        if(status === 'denied') {
            return (
                <View style={styles.center}>
                    ...
                    <Text style={{textAlign:'center'}}>You denied access to Location. You can enable this by visiting Location services in your settings.</Text>
                </View>
            )
        }
        ...
        if(status === 'undetermined') {
            return (
                <View style={styles.center}>
                    <Foundation size={30} name='alert'/>
                    <Text style={{textAlign:'center'}}>You need to enable location services to use the app</Text>
